...
| 8 | Dry run і негативні сценарії | ✅ Виконано |
| 9 | Фінальний запуск pipeline | ⏭️ Наступна |
...
- Контракти визначають, який agent preload-ить кожен skill.
- Фактичний preload в agent frontmatter перевіряється у фазі 6.
- Перевірка наявності skills в orchestrator додається у фазі 7.
